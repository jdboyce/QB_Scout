    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected async void ImgQBOAPICall_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var sku = "NEWSKU2";
             ...
             //dynamic dataOut1 = JsonConvert.DeserializeObject<dynamic>(dataOut3);
             
            RestClient client = new RestClient("https://sandbox-quickbooks.api.intuit.com");

            {
                var request = new RestRequest("/v3/company/193514594476764/query?query={SQL}&minorversion=4", Method.GET);

                request.RequestFormat = DataFormat.Json;
                request.AddUrlSegment("SQL", "select * from Item where Name = '"+itemName+"' maxresults 1");
                request.AddHeader("Content-Type", "application/json;charset=UTF-8");
                request.AddHeader("Authorization", "Bearer " + dictionary["accessToken"]);
...

            {
                ...
                var request = new RestRequest("/v3/company/193514594476764/item?operation=update&minorversion=4", Method.POST);
            ...
            //request = new RestRequest("/v3/company/193514594476764/item?operation=update", Method.POST);
        ...
        public void output(string logMsg)
        {
            ...
            //System.IO.StreamWriter sw = System.IO.File.AppendText(GetLogPath() + "QB_ScoutLog.txt");
            //try
            //{
        ...
        {
            var itemName = item_text.Value; //"300528";
            var syncToken = "";
            var id = 0;
            var sku = location_text.Value;
        ...
        //public void UpdateSKU(string id, string SKU)
        //{
        //    try
        //    {
        //        string access_token = dictionary["accessToken"];
        //        string refresh_token = dictionary["refreshToken"];
        //        string realmId = dictionary["realmId"];
...
//var dataOut = "{\"Item\":{\"Name\":\"Concrete\",\"Description\":\"Concrete for fountain installation\",\"Active\":false,\"FullyQualifiedName\":\"Concrete\",\"Taxable\":true,\"UnitPrice\":0,\"Type\":\"Service\",\"IncomeAccountRef\":{\"value\":\"48\",\"name\":\"Landscaping Services:Job Materials:Fountains and Garden Lighting\"},\"PurchaseCost\":0,\"TrackQtyOnHand\":false,\"domain\":\"QBO\",\"sparse\":false,\"Id\":\"3\",\"SyncToken\":\"3\",\"MetaData\":{\"CreateTime\":\"2017-08-09T10:36:03-07:00\",\"LastUpdatedTime\":\"2018-02-22T11:52:32-08:00\"}},\"time\":\"2018-02-22T11:53:20.847-08:00\"}";



//var dataOut2 = "{\"Name\":\"Concrete\",\"Description\":\"Concrete for fountain installation\",\"Active\":false,\"FullyQualifiedName\":\"Concrete\",\"Taxable\":true,\"UnitPrice\":0,\"Type\":\"Service\",\"IncomeAccountRef\":{\"value\":\"48\",\"name\":\"Landscaping Services:Job Materials:Fountains and Garden Lighting\"},\"PurchaseCost\":0,\"TrackQtyOnHand\":false,\"domain\":\"QBO\",\"sparse\":false,\"Id\":\"3\",\"SyncToken\":\"3\",\"MetaData\":{\"CreateTime\":\"2017-08-09T10:36:03-07:00\",\"LastUpdatedTime\":\"2018-02-22T11:52:32-08:00\"}}";
...
//                    "\"SyncToken\": \"5\"," +
//                    "\"MetaData\": {" +
//                                "\"CreateTime\": \"2017-08-09T10:36:03-07:00\"," +
//                      "\"LastUpdatedTime\": \"2018-02-22T15:27:28-08:00\"}";
...
//var request = new RestRequest("/v3/company/193514594476764/item/3", Method.GET);
...
//dynamic dataIn = JsonConvert.DeserializeObject<dynamic>(response.Content);
...
//            "MetaData":
//                {
//            "CreateTime":"2017-08-04T14:42:05-07:00",
//                 "LastUpdatedTime":"2018-02-22T00:08:29-08:00"}
//    },
//          "time":"2018-02-22T00:52:41.657-08:00"
//   }
...
//var dataOut = "{\"Item\":{\"Name\":\"Scout\",\"Active\":"+
//    "false"+
//    ",\"FullyQualifiedName\":\"Scout\","+
//    "\"Taxable\":false,\"UnitPrice\":0,\"Type\":\"Service\",\"IncomeAccountRef\":{\"value\":\"1\","+
//    "\"name\":\"Services\"},\"PurchaseCost\":0,\"TrackQtyOnHand\":false,\"domain\":\"QBO\",\"sparse\":false,"+
//    "\"Id\":\"1\",\"SyncToken\":\"5\",\"MetaData\":{\"CreateTime\":\"2017-08-04T14:42:05-07:00\",\"LastUpdatedTime\":\"" +
//    DateTime.Now.ToString("yyyy-MM-dd'T'HH:mm:ss-'08:00'")+
//    "\"}},\"time\":\"2018-02-22T00:52:41.657-08:00\"}";
...
//{
//    CreateTime = "2017-08-09T10:36:03-07:00",
//    LastUpdatedTime = "2018-02-22T15:29:25-08:00"
//    //DateTime.Now.ToString("yyyy-MM-dd'T'HH:mm:ss-'08:00'"
//    //LastUpdatedTime = DateTime.Now.ToString("yyyy-MM-dd'T'HH:mm:ss-'08:00'")
//}
...
//{
//    CreateTime = "2017-08-09T10:36:03-07:00",
//    //LastUpdatedTime = "2018-02-22T15:37:28-08:00"
//    //DateTime.Now.ToString("yyyy-MM-dd'T'HH:mm:ss-'08:00'"
//    LastUpdatedTime = DateTime.Now.ToString("yyyy-MM-dd'T'HH:mm:ss-'08:00'")
//}
